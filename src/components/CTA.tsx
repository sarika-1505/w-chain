    ...
    <section className="relative w-full h-auto pt-16 pb-[120px] md:h-[524px] md:py-0 flex flex-col items-center justify-center bg-[#00040a] -mb-[80px] lg:-mb-[100px] z-10">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-6">
          <Link href="#" className="group flex items-center gap-3 px-6 py-3 rounded-full border border-white/40 bg-black/40 backdrop-blur-sm hover:bg-white/10 transition text-white">
