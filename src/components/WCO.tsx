      ...
      <section className="relative w-full h-[800px] overflow-hidden rounded-b-[40px] md:rounded-b-[50px] border-b border-l border-r border-[#4EA5FF]/30 -mb-[40px] md:-mb-[50px] z-10 flex items-center justify-center font-Montserrat bg-[#020B2D]">
        ...
        <div className="relative z-10 w-full max-w-[1200px] px-6 md:px-10 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 flex flex-col items-start max-w-[600px] w-full">
            <h1 className="font-Montserrat text-transparent bg-clip-text bg-[linear-gradient(90deg,#0D7FF2_0%,#B4E4FF_50%,#1F9DD8_100%)] text-[30px] sm:text-[40px] lg:text-[50px] font-bold leading-[1.2] lg:leading-[60px] tracking-[-0.03em] mb-8 lg:w-[560px] lg:h-[169px] w-full h-auto">
              Powering Payments &
              <br />
