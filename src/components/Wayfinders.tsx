    ...
    <div className="w-full bg-[#020B2D] flex flex-col items-center">
      ...
      <section className="w-full max-w-[1200px] pt-[120px] pb-[80px] px-4 md:px-10 text-center flex flex-col items-center relative">
        ...
        <div className="space-y-8 text-white/90 text-[18px] md:text-[20px] leading-[32px] font-light mb-12 max-w-[1000px]">
          <p>
            The WayFinders Program features a tiered structure - Rising,
            Premium, and Elite-designed to recognize contributions at every
            level.
          </p>
          <p>
            Whether you&apos;re a new creator, a mid-sized influencer, or a Web3
            expert, there&apos;s a place for you to shine.
          </p>
          <p>
            As a WayFinder, you&apos;ll engage with our community, share
            updates, and contribute to W Chain&apos;s growth through content
            creation, discussions, and more.
          </p>
        </div>
      ...
      <section className="w-full bg-gradient-to-br from-[#000D27] to-[#002F8D] py-20 flex flex-col items-center relative z-10">
        <div className="w-full max-w-[1200px] flex flex-col items-center text-center px-4 md:px-10">
          ...
          <p className="text-white/90 text-[18px] md:text-[20px] font-light max-w-[800px] mb-12">
            WayFinders earn monthly rewards based on their tier and
            contributions, including WCO tokens, exclusive NFTs, and special
            perks like mentorship and alpha leaks. Your efforts will be
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-[850px] mx-auto text-left">
            ...
            <div className="bg-white/5 p-8 rounded-[20px] border border-white/10 w-full h-[200px] flex flex-col justify-center backdrop-blur-sm">
              ...
              <h3 className="text-[#2196F3] text-[20px] font-bold mb-2">
                Be a Leader
              </h3>
              <p className="text-white/80 text-[15px] font-light leading-snug">
                Shape the W Chain ecosystem by sharing news, leading
            ...
            <div className="bg-white/5 p-8 rounded-[20px] border border-white/10 w-full h-[200px] flex flex-col justify-center backdrop-blur-sm">
              <div className="w-[50px] h-[50px] rounded-lg bg-white/5 flex items-center justify-center mb-4">
                <Image
                  src="/Group 163303 (1).png"
                  alt="Grow Your Influence"
                  width={24}
                  height={24}
                  className="object-contain"
                />
            ...
            <div className="bg-white/5 p-8 rounded-[20px] border border-white/10 w-full h-[200px] flex flex-col justify-center backdrop-blur-sm">
              <div className="w-[50px] h-[50px] rounded-lg bg-white/5 flex items-center justify-center mb-4">
                <Image
                  src="/Group 163303 (2).png"
                  alt="Access Exclusive Benefits"
                  width={24}
                  height={24}
                  className="object-contain"
                />
              ...
              <p className="text-white/80 text-[15px] font-light leading-snug">
                Enjoy early access to updates, direct communication with the W
                Chain team, and more.
              </p>
            </div>
            ...
            <div className="bg-white/5 p-8 rounded-[20px] border border-white/10 w-full h-[200px] flex flex-col justify-center backdrop-blur-sm">
              ...
              <p className="text-white/80 text-[15px] font-light leading-snug">
                Earn monthly rewards based on tier and contributions, including
          ...
          <form className="w-full flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
              <input
                ...
                className="w-full bg-[#1C2C54]/30 border border-white/20 rounded-[12px] px-6 py-5 text-white placeholder-white/60 focus:outline-none focus:border-[#2196F3] font-light text-[16px] italic"
              />
              <input
                type="email"
              ...
              <input
                type="text"
                placeholder="Follower Count & Weekly Impressions"
                className="w-full bg-[#1C2C54]/30 border border-white/20 rounded-[12px] px-6 py-5 text-white placeholder-white/60 focus:outline-none focus:border-[#2196F3] font-light text-[16px] italic"
              />
              <input
                type="text"
              ...
              <input
                type="text"
                placeholder="Provide an Idea or examples"
                className="w-full bg-[#1C2C54]/30 border border-white/20 rounded-[12px] px-6 py-5 text-white placeholder-white/60 focus:outline-none focus:border-[#2196F3] font-light text-[16px] italic"
              />
              ...
              <div className="relative w-full">
                <input
                  type="text"
                  placeholder="Preferred Tier"
                  className="w-full bg-[#1C2C54]/30 border border-white/20 rounded-[12px] px-6 py-5 text-white placeholder-white/60 focus:outline-none focus:border-[#2196F3] font-light text-[16px] appearance-none italic cursor-pointer"
                  readOnly
                />
